...
def _samples():
    ...
    # ── 사용자 알림 유형 ──────────────────────────────────────────
    out.append(("매수 신호", notify.format_buy_level(
        "QQQ", 10, 412.35, 458.17, -10.0, name=None,
    ...
    out.append(("매도 신호 (ATH 도달)", notify.format_sell(
        "QQQ", 0, 458.20, 458.17, 0.0, name=None, cash_target=50)))

    out.append(("매도 신호 (+10%)", notify.format_sell(
        "QQQ", 10, 504.00, 458.17, 10.0, name=None, cash_target=50)))
